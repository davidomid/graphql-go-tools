...
func (r *Request) ValidateForSchema(schema *Schema, opts ...astvalidation.Option) (result ValidationResult, err error) {
	if schema == nil {
	...
	validator := astvalidation.DefaultOperationValidator(opts...)
